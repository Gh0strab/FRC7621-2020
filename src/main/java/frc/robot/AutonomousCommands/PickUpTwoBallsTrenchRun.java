...
public class PickUpTwoBallsTrenchRun extends CommandGroup{
    ...
    private static String trajectoryJSON = "output/PickUpTwoBallsTrenchRun.wpilib.json";
    ...
    public PickUpTwoBallsTrenchRun(){
